...
At the moment, only a few tools are functioning. Game build doesn't work. Valid build targets are: Debug Win32/Debug/Editor-Debug. Retail/Relase Win32 is temporary broken.
